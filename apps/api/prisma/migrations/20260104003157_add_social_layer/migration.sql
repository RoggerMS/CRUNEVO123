-- AlterEnum
ALTER TYPE "TargetType" ADD VALUE 'POST';
...
-- AddForeignKey
ALTER TABLE "Like" ADD CONSTRAINT "Like_documentId_fkey" FOREIGN KEY ("documentId") REFERENCES "Document"("id") ON DELETE SET NULL ON UPDATE CASCADE;
