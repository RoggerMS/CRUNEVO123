...
import { Bell, CalendarDays, FileText, GraduationCap, Home, MessageCircle, Receipt, Shield, Store as StoreIcon, Users, BookOpen } from 'lucide-react';
...
import AppMenu, { AppMenuSection } from './components/AppMenu';
    ...
    const sections: AppMenuSection[] = [
      {
        title: 'Social',
        items: [
          { label: 'Feed', description: 'Explora las novedades de tu red.', to: '/feed', icon: <Home size={18} /> },
