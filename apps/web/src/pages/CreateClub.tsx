...
const defaultCover = 'https://images.unsplash.com/photo-1523580846011-d3a5bc25702b?auto=format&fit=crop&w=1200&q=60';
...
export default function CreateClub() {
  ...
  const previewImage = coverImageUrl.trim() || defaultCover;
  ...
  return (
    <div className="container">
      <div className="card" style={{ marginBottom: '1.5rem' }}>
        <Link to="/clubs" style={{ textDecoration: 'none', color: '#2563eb', fontWeight: 600 }}>← Volver a Clubes</Link>
      ...
      <div className="card" style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '1.5rem' }}>
        <div>
          <div style={{ width: '100%', aspectRatio: '16 / 9', borderRadius: '12px', overflow: 'hidden', border: '1px solid #e5e7eb' }}>
            <img 
              src={previewImage} 
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div>
            <label style={{ display: 'block', fontWeight: 600, marginBottom: '0.35rem' }}>Nombre del club</label>
            <input 
          ...
          <div>
            <label style={{ display: 'block', fontWeight: 600, marginBottom: '0.35rem' }}>Descripción</label>
            <textarea 
          ...
          <div>
            <label style={{ display: 'block', fontWeight: 600, marginBottom: '0.35rem' }}>URL de portada (opcional)</label>
            <input 
