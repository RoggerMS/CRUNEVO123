  ...
  return (
    <div className="container">
      ...
      <div className="card" style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '1.5rem' }}>
        <div>
          <div style={{ width: '100%', aspectRatio: '16 / 9', borderRadius: '12px', overflow: 'hidden', border: '1px solid #e5e7eb', background: '#f3f4f6', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            {previewImage ? (
              <img 
                src={previewImage} 
              ...
              <span style={{ color: '#9ca3af', fontWeight: 600 }}>Agrega una portada 16:9</span>
            )}
          </div>
